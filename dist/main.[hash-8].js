...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! img/sunset2.jpg */ "./src/img/sunset2.jpg"), __webpack_require__.b);
...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,cAAc;EACd,sBAAsB;EACtB,uBAAuB;EACvB,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,6BAA6B;EAC7B,yDAAwC;EACxC,sBAAsB;AACxB;AACA;EACE,eAAe;EACf,iBAAiB;AACnB;AACA;EACE,eAAe;EACf,iBAAiB;AACnB;AACA;EACE,aAAa;EACb,uBAAuB;EACvB,iBAAiB;EACjB,eAAe;AACjB;AACA;EACE;;2BAEyB;EACzB,gBAAgB;EAChB,eAAe;AACjB;;AAEA;;EAEE,gBAAgB;EAChB,eAAe;AACjB;AACA;EACE,eAAe;EACf,YAAY;EACZ,iBAAiB;AACnB;AACA;EACE,eAAe;EACf,YAAY;AACd;AACA;EACE,cAAc;AAChB;AACA;EACE,eAAe;EACf,YAAY;EACZ,6BAA6B;EAC7B,aAAa;EACb,qCAAqC;EACrC,mBAAmB;EACnB,2BAA2B;EAC3B,yDAAuC;EACvC,yBAAyB;AAC3B;AACA;EACE,cAAc;EACd,gBAAgB;EAChB,kBAAkB;EAClB,uBAAuB;AACzB;;AAEA;EACE,6BAA6B;AAC/B;AACA;EACE,UAAU;EACV,cAAc;EACd,uBAAuB;AACzB;AACA;EACE,iBAAiB;AACnB","sourcesContent":["* {\n  margin: 0 auto;\n  box-sizing: border-box;\n  scroll-behavior: smooth;\n  text-align: center;\n  color: white;\n}\n\nbody {\n  background-color: transparent;\n  background-image: url(\"img/sunset2.jpg\");\n  background-size: cover;\n}\nh1 {\n  font-size: 30px;\n  font-weight: bold;\n}\nh2 {\n  font-size: 24px;\n  font-weight: bold;\n}\n.temperature {\n  display: flex;\n  justify-content: center;\n  margin: 20px auto;\n  font-size: 24px;\n}\n.city-name {\n  /*display: flex;\n  align-self: center;\n  justify-content: center;*/\n  margin: 5px auto;\n  font-size: 24px;\n}\n\n.city-temp {\n  \n  margin: 5px auto;\n  font-size: 24px;\n}\nbutton {\n  font-size: 20px;\n  color: black;\n  margin-left: 20px;\n}\ninput {\n  font-size: 20px;\n  color: black;\n}\n.list {\n  display: block;\n}\n#header-container {\n  font-size: 24px;\n  color: white;\n  background-color: transparent;\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  align-items: center;\n  /*justify-content: center;*/\n  background-image: url(\"img/sunset.jpg\");\n  background-position: left;\n}\n.loclal {\n  display: block;\n  margin-top: 20px;\n  text-align: bottom;\n  background-color: beige;\n}\n\n#weather-box {\n  background-color: transparent;\n}\n.list {\n  width: 30%;\n  margin: 0 auto;\n  /* border-style: none;*/\n}\n#map-container {\n  margin-bottom: 2%;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */ });
/* harmony import */ var _hasWeather_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hasWeather.js */ "./src/hasWeather.js");
/* harmony import */ var _getCity_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getCity.js */ "./src/getCity.js");



async function getLocalWeather(inner) {
  const nameOfLocalCity = document.createElement("p");
  nameOfLocalCity.classList.add("local");
  const place = await (0,_getCity_js__WEBPACK_IMPORTED_MODULE_1__.getCity)();
  ...
  const data = await (0,_hasWeather_js__WEBPACK_IMPORTED_MODULE_0__.hasWeather)(place);
...
async function getWeather(wrapper) {
  ...
  form.addEventListener("submit", async (ev) => {
    ...
    let weather = await (0,_hasWeather_js__WEBPACK_IMPORTED_MODULE_0__.hasWeather)(cityName);
    ...
    if (cityN.textContent) {
      ...
      newButton.addEventListener("click", async () => {
        ...
        weather = await (0,_hasWeather_js__WEBPACK_IMPORTED_MODULE_0__.hasWeather)(cityName);
        city.textContent = `Город :  ${cityN.textContent}`;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   hasWeather: () => (/* binding */ hasWeather)
/* harmony export */ });
...
module.exports = __webpack_require__.p + "img/sunset-8e80f.jpg";
...
module.exports = __webpack_require__.p + "img/sunset2-aee09.jpg";
...
(0,_getWeather_js__WEBPACK_IMPORTED_MODULE_1__.getLocalWeather)(document.querySelector("#header-container"));
// import { getWeather } from "./getWeather.js";

(0,_getWeather_js__WEBPACK_IMPORTED_MODULE_1__.getWeather)(document.querySelector("#container"));
